...
const sendInviteEmail = async (to: string, inviteLink: string) => {
  ...
  const subject = "OQEP Survey Invitation";
  const html = `
    <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #111827;">
      <h2 style="margin-bottom: 8px;">OQEP Employee Survey</h2>
      <p>Please click the secure link below to start your survey:</p>
      <p>
        <a href="${inviteLink}" style="display:inline-block;padding:10px 16px;background:#0f766e;color:#fff;text-decoration:none;border-radius:6px;">
          Start Survey
        </a>
      </p>
